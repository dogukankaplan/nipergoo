...
@section('meta_description', 'Ücretsiz keşif ve fiyat teklifi için hemen iletişime geçin. ' . setting('contact_phone'))
                ...
                <div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <a href="tel:{{ setting('contact_phone') }}" class="text-blue-600 hover:text-blue-700 mt-1 block">{{ setting('contact_phone') }}</a>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <a href="mailto:{{ setting('contact_email') }}" class="text-blue-600 hover:text-blue-700 mt-1 block">{{ setting('contact_email') }}</a>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600 mt-1">{{ setting('working_hours') }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-10">
                        ...
                        <div class="flex space-x-4">
                            ...
                            <a href="{{ setting('social_facebook') }}" target="_blank" class="w-10 h-10 bg-gray-100 hover:bg-blue-600 hover:text-white text-gray-600 rounded-full flex items-center justify-center transition-colors">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                            </a>
                            @endif
                            @if(setting('social_instagram'))
                            <a href="{{ setting('social_instagram') }}" target="_blank" class="w-10 h-10 bg-gray-100 hover:bg-pink-600 hover:text-white text-gray-600 rounded-full flex items-center justify-center transition-colors">
                            ...
                            <a href="{{ setting('social_youtube') }}" target="_blank" class="w-10 h-10 bg-gray-100 hover:bg-red-600 hover:text-white text-gray-600 rounded-full flex items-center justify-center transition-colors">
                        ...
                        <form action="{{ route('contact.store') }}" method="POST" class="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea name="message" id="message" rows="5" required
                                          class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-colors outline-none resize-none">{{ old('message') }}</textarea>
                            </div>
