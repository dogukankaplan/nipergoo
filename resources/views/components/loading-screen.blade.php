    ...
    <div class="relative flex flex-col items-center gap-8">
        ...
        <div class="relative">
            ...
            <div class="absolute inset-0 blur-2xl opacity-50">
                <img src="{{ asset('images/logo.png') }}" alt="NiPergo" class="h-16 lg:h-20 opacity-50">
            </div>

            <!-- Main logo -->
            <img src="{{ asset('images/logo.png') }}" alt="NiPergo" class="relative h-16 lg:h-20 animate-pulse">
        </div>
