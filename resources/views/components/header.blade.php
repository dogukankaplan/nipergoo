    ...
    >
        ...
        <div class="container mx-auto px-4 lg:px-8 h-full flex items-center justify-between relative">
            ...
            <div class="flex items-center gap-4 ml-auto">
                ...
                <!-- Phone -->
                <a href="tel:{{ setting('contact_phone', '+90 532 134 30 16') }}" class="flex items-center gap-2 text-slate-300 hover:text-white transition-colors group">
                    ...
                    <span class="text-xs font-medium tracking-wide">{{ setting('contact_phone', '+90 532 134 30 16') }}</span>
                </a>
                ...
                <div class="flex items-center gap-2">
                    @if(setting('facebook'))
                        <a href="{{ setting('facebook') }}" target="_blank" class="w-7 h-7 rounded-full bg-white/5 hover:bg-blue-500/20 flex items-center justify-center text-slate-400 hover:text-blue-400 transition-all hover:scale-110">
                            <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                        </a>
                    @endif
                    @if(setting('instagram'))
                        <a href="{{ setting('instagram') }}" target="_blank" class="w-7 h-7 rounded-full bg-white/5 hover:bg-gradient-to-br hover:from-purple-500/20 hover:to-pink-500/20 flex items-center justify-center text-slate-400 hover:text-pink-400 transition-all hover:scale-110">
            ...
            <div class="flex items-center justify-between transition-all duration-500" :class="scrolled ? 'h-16' : 'h-18 lg:h-20'">
                ...
                <a href="{{ route('home') }}" class="flex-shrink-0 group relative z-10">
                    ...
                    @else
                        ...
                        >
                            {{ setting('site_name', 'NiPergo') }}<span class="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">.</span>
                        </span>
                    @endif
                </a>
    ...
    >
        ...
        <div class="w-full max-w-4xl relative z-10" @click.outside="searchOpen = false">
            ...
            <div class="mt-10 flex flex-wrap justify-center gap-3">
                ...
                <a href="{{ route('home') }}" class="px-4 py-2 rounded-full bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 text-sm font-medium text-blue-600 dark:text-blue-400 hover:shadow-lg transition-all hover:scale-105">Pergola</a>
                <a href="{{ route('home') }}" class="px-4 py-2 rounded-full bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 text-sm font-medium text-purple-600 dark:text-purple-400 hover:shadow-lg transition-all hover:scale-105">Bioklimatik</a>
                <a href="{{ route('home') }}" class="px-4 py-2 rounded-full bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20 text-sm font-medium text-emerald-600 dark:text-emerald-400 hover:shadow-lg transition-all hover:scale-105">Kış Bahçesi</a>
            </div>
        </div>
    </div>
    ...
    <div x-show="mobileMenuOpen" class="fixed inset-0 z-[70] lg:hidden" x-cloak>
        ...
        >
            ...
            <div class="flex-1 overflow-y-auto p-4 space-y-1">
                <a href="{{ route('home') }}" class="mobile-nav-item block px-4 py-3.5 rounded-xl text-base font-semibold text-slate-700 dark:text-slate-200 hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 dark:hover:from-blue-900/20 dark:hover:to-indigo-900/20 hover:text-blue-600 dark:hover:text-blue-400 transition-all">
                    Anasayfa
                </a>
                
                @foreach($categories as $index => $category)
                    <div class="mobile-nav-item rounded-xl overflow-hidden" style="animation-delay: {{ ($index + 1) * 0.05 }}s">
                        <button 
                        ...
                        >
                            ...
                            @if($category->children->count() || $category->products->count())
                                <svg class="w-4 h-4 transition-transform duration-300" :class="mobileSubmenuOpen === {{ $category->id }} ? 'rotate-180 text-blue-500' : 'text-slate-400'" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
                            @endif
                        </button>
                ...
                <a href="{{ route('blog') }}" class="mobile-nav-item block px-4 py-3.5 rounded-xl text-base font-semibold text-slate-700 dark:text-slate-200 hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 dark:hover:from-blue-900/20 dark:hover:to-indigo-900/20 hover:text-blue-600 dark:hover:text-blue-400 transition-all" style="animation-delay: 0.3s">
                    Blog
                </a>
                <a href="{{ route('contact') }}" class="mobile-nav-item block px-4 py-3.5 rounded-xl text-base font-semibold text-slate-700 dark:text-slate-200 hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 dark:hover:from-blue-900/20 dark:hover:to-indigo-900/20 hover:text-blue-600 dark:hover:text-blue-400 transition-all" style="animation-delay: 0.35s">
                    İletişim
                </a>
            </div>
