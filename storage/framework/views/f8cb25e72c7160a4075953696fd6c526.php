...
<?php $__env->startSection('title', $product->meta_title ?? $product->title . ' | ' . setting('site_name')); ?>
    ...
    <section class="py-16 bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 relative overflow-hidden">
        ...
        <div class="container mx-auto px-4 relative z-10">
            <nav class="text-blue-200 mb-4">
                ...
                <a href="<?php echo e(route('category', $category->slug)); ?>" class="hover:text-white"><?php echo e($category->name); ?></a>
                <span class="mx-2">/</span>
                <span class="text-white"><?php echo e($product->title); ?></span>
            </nav>
            <h1 class="text-3xl md:text-4xl font-bold text-white"><?php echo e($product->title); ?></h1>
        </div>
    </section>
        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16">
                ...
                <div>
                    ...
                    <?php if($product->gallery && count($product->gallery) > 0): ?>
                        <div class="grid grid-cols-4 gap-4 mt-4">
                            <?php $__currentLoopData = $product->gallery_urls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div
                                    class="aspect-square rounded-lg overflow-hidden bg-gray-100 cursor-pointer hover:opacity-80 transition-opacity">
                                    <img src="<?php echo e($image); ?>" alt="<?php echo e($product->title); ?>" class="w-full h-full object-cover">
                                </div>
                ...
                <div>
                    ...
                    <h2 class="text-3xl font-bold text-gray-900 mb-4"><?php echo e($product->title); ?></h2>
                    ...
                    <div class="flex flex-wrap gap-4">
                        ...
                        <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', setting('contact_whatsapp'))); ?>?text=<?php echo e(urlencode($product->title . ' hakkında bilgi almak istiyorum.')); ?>"
                            target="_blank"
            ...
            <div class="container mx-auto px-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <?php $__currentLoopData = $relatedProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $related): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('product', [$category->slug, $related->slug])); ?>"
