...
<footer class="relative overflow-hidden">
    ...
    <div class="relative container mx-auto px-4 lg:px-8 py-16 lg:py-20">
        ...
        <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8 pb-12 border-b border-slate-700/50">
            <!-- Logo & Tagline -->
            <div class="max-w-md">
                <a href="<?php echo e(route('home')); ?>" class="group inline-flex items-center gap-1 mb-4">
                    <?php if(setting('site_logo')): ?>
                        <img src="<?php echo e(asset('storage/' . setting('site_logo'))); ?>" alt="<?php echo e(setting('site_name')); ?>" class="h-10 transition-transform group-hover:scale-105">
                    <?php else: ?>
                        <img src="<?php echo e(asset('images/logo.png')); ?>" alt="NiPergo" class="h-9 transition-all group-hover:scale-105 group-hover:drop-shadow-[0_0_15px_rgba(59,130,246,0.4)]">
                    <?php endif; ?>
                </a>
                <p class="text-slate-400 text-sm leading-relaxed">
                    <?php echo e(setting('about_short', 'Alüminyum doğrama, pergola ve gölgelendirme sistemlerinde uzman çözümler. İzmir ve çevresinde kaliteli hizmet.')); ?>
            ...
            <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                <a href="<?php echo e(route('contact')); ?>" class="group flex items-center gap-3 px-6 py-3 btn-premium text-white rounded-xl font-semibold text-sm">
                ...
                <a href="tel:<?php echo e(setting('contact_phone', '+90 532 134 30 16')); ?>" class="flex items-center gap-3 px-6 py-3 bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl text-white font-medium text-sm transition-all hover:scale-105">
                    <svg class="w-4 h-4 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>
                    <span><?php echo e(setting('contact_phone', '+90 532 134 30 16')); ?></span>
                </a>
            </div>
        </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-12 py-12">
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li>
                        <a href="<?php echo e(route('home')); ?>" class="text-slate-400 hover:text-white text-sm transition-colors inline-flex items-center gap-2 group">
                            <span class="w-0 group-hover:w-2 h-px bg-blue-400 transition-all"></span>
                            Anasayfa
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('about')); ?>" class="text-slate-400 hover:text-white text-sm transition-colors inline-flex items-center gap-2 group">
                            <span class="w-0 group-hover:w-2 h-px bg-blue-400 transition-all"></span>
                            Hakkımızda
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('blog')); ?>" class="text-slate-400 hover:text-white text-sm transition-colors inline-flex items-center gap-2 group">
                            <span class="w-0 group-hover:w-2 h-px bg-blue-400 transition-all"></span>
                            Blog
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('contact')); ?>" class="text-slate-400 hover:text-white text-sm transition-colors inline-flex items-center gap-2 group">
                            <span class="w-0 group-hover:w-2 h-px bg-blue-400 transition-all"></span>
                            İletişim
                        </a>
                    </li>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <?php $__currentLoopData = $categories->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>
                            <a href="<?php echo e(route('category', $category->slug)); ?>" class="text-slate-400 hover:text-white text-sm transition-colors inline-flex items-center gap-2 group">
            ...
            <div>
                ...
                <ul class="space-y-4">
                    <li class="flex items-start gap-3">
                        ...
                        <span class="text-slate-400 text-sm"><?php echo e(setting('contact_address', 'Barbaros Mahallesi 5301 Sokak No:6 Bornova-İzmir')); ?></span>
                    </li>
                    <li class="flex items-center gap-3">
                        ...
                        <a href="tel:<?php echo e(setting('contact_phone')); ?>" class="text-slate-400 hover:text-white text-sm transition-colors"><?php echo e(setting('contact_phone', '+90 532 134 30 16')); ?></a>
                    </li>
                    <li class="flex items-center gap-3">
                        ...
                        <a href="mailto:<?php echo e(setting('contact_email')); ?>" class="text-slate-400 hover:text-white text-sm transition-colors"><?php echo e(setting('contact_email', 'info@nipergo.com.tr')); ?></a>
                    </li>
                </ul>
            </div>
            ...
            <div class="flex flex-col md:flex-row items-center justify-between gap-6">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <?php if(setting('social_facebook')): ?>
                        <a href="<?php echo e(setting('social_facebook')); ?>" target="_blank" class="w-10 h-10 rounded-xl bg-white/5 hover:bg-blue-500/20 flex items-center justify-center text-slate-400 hover:text-blue-400 transition-all hover:scale-110 border border-white/5 hover:border-blue-500/30">
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                        </a>
                    <?php endif; ?>
                    <?php if(setting('social_instagram')): ?>
                        <a href="<?php echo e(setting('social_instagram')); ?>" target="_blank" class="w-10 h-10 rounded-xl bg-white/5 hover:bg-gradient-to-br hover:from-purple-500/20 hover:to-pink-500/20 flex items-center justify-center text-slate-400 hover:text-pink-400 transition-all hover:scale-110 border border-white/5 hover:border-pink-500/30">
                    ...
                    <?php if(setting('social_youtube')): ?>
                        <a href="<?php echo e(setting('social_youtube')); ?>" target="_blank" class="w-10 h-10 rounded-xl bg-white/5 hover:bg-red-500/20 flex items-center justify-center text-slate-400 hover:text-red-400 transition-all hover:scale-110 border border-white/5 hover:border-red-500/30">
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
                        </a>
                    <?php endif; ?>
                    <?php if(setting('social_linkedin')): ?>
                        <a href="<?php echo e(setting('social_linkedin')); ?>" target="_blank" class="w-10 h-10 rounded-xl bg-white/5 hover:bg-blue-600/20 flex items-center justify-center text-slate-400 hover:text-blue-500 transition-all hover:scale-110 border border-white/5 hover:border-blue-600/30">
                ...
                <div class="flex flex-col sm:flex-row items-center gap-4 text-slate-500 text-sm">
                    <span>© <?php echo e(date('Y')); ?> <?php echo e(setting('site_name', 'NiPergo')); ?>. Tüm hakları saklıdır.</span>
...
</footer><?php /**PATH C:\Users\HUAWEI\Documents\GitHub\nipergo\resources\views/components/footer.blade.php ENDPATH**/ ?>