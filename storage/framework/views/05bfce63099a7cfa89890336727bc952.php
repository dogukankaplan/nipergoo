...
<head>
    ...
    <title>Admin Girişi | <?php echo e(setting('site_name', 'NiPergo')); ?></title>
...
<body
    ...
    <div class="w-full max-w-md">
        <div class="text-center mb-8">
            <h1 class="text-3xl font-bold text-white"><?php echo e(setting('site_name', 'NiPergo')); ?></h1>
        ...
        <p class="text-center text-blue-300 mt-6 text-sm">
            <a href="<?php echo e(route('home')); ?>" class="hover:text-white">← Siteye Dön</a>
        </p>
    </div>
</body>

</html><?php /**PATH C:\Users\HUAWEI\Documents\GitHub\nipergo\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>