...
<?php $__env->startSection('title', setting('seo_title')); ?>
<?php $__env->startSection('meta_description', setting('seo_description')); ?>
                ...
                <?php if($sliders->count() > 0): ?>
                    ...
                    <div class="animate-fade-in-up">
                        ...
                        <?php if($slider->subtitle): ?>
                            <p class="text-xl md:text-2xl text-blue-200 mb-4"><?php echo e($slider->subtitle); ?></p>
                        <?php endif; ?>
                        <?php if($slider->description): ?>
                            <p class="text-lg text-gray-300 mb-8 max-w-2xl"><?php echo e($slider->description); ?></p>
                        <?php endif; ?>
                        <div class="flex flex-wrap gap-4">
                            <?php if($slider->button_url): ?>
                                <a href="<?php echo e($slider->button_url); ?>"
                                    ...
                                    <?php echo e($slider->button_text ?? 'İletişime Geç'); ?>
                ...
                <?php $__currentLoopData = $features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div
                        ...
                        <h3 class="text-xl font-bold text-gray-900 group-hover:text-white mb-3 transition-colors">
                            <?php echo e($feature->title); ?></h3>
                        <p class="text-gray-600 group-hover:text-blue-100 transition-colors"><?php echo e($feature->description); ?></p>
                    </div>
                ...
                <div class="mt-16">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <?php $__currentLoopData = $featuredProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('product', [$product->category->slug, $product->slug])); ?>"
                                ...
                                <h4 class="text-lg font-semibold text-gray-900 group-hover:text-blue-600 transition-colors mb-2">
                                    <?php echo e($product->title); ?></h4>
                                <p class="text-gray-600 text-sm mb-3"><?php echo e($product->short_description); ?></p>
        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                <div class="text-white">
                    <div class="text-4xl md:text-5xl font-bold mb-2"><?php echo e(setting('about_experience', '10+')); ?></div>
                    <div class="text-blue-200">Yıllık Tecrübe</div>
                </div>
                <div class="text-white">
                    <div class="text-4xl md:text-5xl font-bold mb-2"><?php echo e(setting('about_projects', '10000+')); ?></div>
                    ...
                    <?php $__currentLoopData = $latestPosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <article
                            ...
                            <div class="p-6">
                                ...
                                <p class="text-gray-600 mb-4 line-clamp-2"><?php echo e($post->excerpt); ?></p>
        ...
        <div class="container mx-auto px-4 relative z-10">
            <div class="max-w-3xl mx-auto text-center">
                ...
                <div class="flex flex-wrap justify-center gap-4">
                    ...
                    <a href="tel:<?php echo e(setting('contact_phone')); ?>"
