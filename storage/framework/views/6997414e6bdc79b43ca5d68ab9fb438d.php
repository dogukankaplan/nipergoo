...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Anasayfa'); ?> | <?php echo e(setting('site_name', 'NiPergo')); ?></title>
    <meta name="description"
        content="<?php echo $__env->yieldContent('description', setting('meta_description', 'NiPergo - İzmir Otomatik Pergola')); ?>">
    <meta name="keywords" content="<?php echo e(setting('meta_keywords', 'pergola, tente, cam balkon')); ?>">

    <!-- Open Graph -->
    <meta property="og:title" content="<?php echo $__env->yieldContent('title', setting('site_name')); ?>">
    <meta property="og:description" content="<?php echo $__env->yieldContent('description', setting('meta_description')); ?>">
        ...
        <template x-if="fabOpen">
            <div class="flex flex-col-reverse items-end gap-3">
                ...
                <?php if(setting('contact_phone')): ?>
                    <a href="tel:<?php echo e(setting('contact_phone')); ?>" x-show="fabOpen"
                ...
                <?php if(setting('social_instagram')): ?>
                    <a href="<?php echo e(setting('social_instagram')); ?>" target="_blank" x-show="fabOpen"
...
</html><?php /**PATH C:\Users\HUAWEI\Documents\GitHub\nipergo\resources\views/layouts/app.blade.php ENDPATH**/ ?>