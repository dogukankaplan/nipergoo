...
<?php $__env->startSection('title', $post->meta_title ?? $post->title . ' | ' . setting('site_name')); ?>
...
<?php $__env->startSection('content'); ?>
        ...
        <div class="container mx-auto px-4 relative z-10">
            <div class="max-w-3xl">
                <nav class="text-blue-200 mb-4">
                    ...
                    <a href="<?php echo e(route('blog')); ?>" class="hover:text-white">Blog</a>
                    <span class="mx-2">/</span>
                    <span class="text-white"><?php echo e($post->title); ?></span>
                </nav>
                <time class="text-blue-300"><?php echo e($post->formatted_date); ?></time>
                <h1 class="text-3xl md:text-4xl font-bold text-white mt-2"><?php echo e($post->title); ?></h1>
            </div>
        </div>
    </section>
    ...
    <section class="py-20 bg-white">
        <div class="container mx-auto px-4">
            <div class="max-w-3xl mx-auto">
                <?php if($post->image): ?>
                    <div class="aspect-[16/9] rounded-2xl overflow-hidden mb-10 shadow-xl">
                        <img src="<?php echo e($post->image_url); ?>" alt="<?php echo e($post->title); ?>" class="w-full h-full object-cover">
                    </div>
                <?php endif; ?>
                ...
                <div class="mt-12 pt-8 border-t border-gray-200">
                    <h3 class="font-semibold text-gray-900 mb-4">Bu yazıyı paylaş</h3>
                    <div class="flex space-x-4">
                        <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo e(urlencode(url()->current())); ?>"
                            target="_blank"
                            class="w-10 h-10 bg-gray-100 hover:bg-blue-600 hover:text-white text-gray-600 rounded-full flex items-center justify-center transition-colors">
                        ...
                        <a href="https://twitter.com/intent/tweet?url=<?php echo e(urlencode(url()->current())); ?>&text=<?php echo e(urlencode($post->title)); ?>"
                            target="_blank"
                            class="w-10 h-10 bg-gray-100 hover:bg-blue-400 hover:text-white text-gray-600 rounded-full flex items-center justify-center transition-colors">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                <path
                        ...
                        <a href="https://wa.me/?text=<?php echo e(urlencode($post->title . ' - ' . url()->current())); ?>"
                            target="_blank"
                            class="w-10 h-10 bg-gray-100 hover:bg-green-500 hover:text-white text-gray-600 rounded-full flex items-center justify-center transition-colors">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                <path
    ...
    <?php if($relatedPosts->count() > 0): ?>
        <section class="py-20 bg-gray-50">
            <div class="container mx-auto px-4">
                <h2 class="text-2xl font-bold text-gray-900 mb-8 text-center">İlgili Yazılar</h2>
                        ...
                        <article class="group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
                            <div class="aspect-[16/10] overflow-hidden bg-gray-200">
                                <?php if($related->image): ?>
                                    <img src="<?php echo e($related->image_url); ?>" alt="<?php echo e($related->title); ?>"
