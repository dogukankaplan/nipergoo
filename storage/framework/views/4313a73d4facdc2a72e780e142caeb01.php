        ...
        <div class="absolute inset-y-0 right-0 w-[88%] max-w-sm bg-white dark:bg-slate-900 shadow-2xl flex flex-col overflow-hidden"
            ...
            <div class="relative px-5 py-4 border-b border-slate-100 dark:border-slate-800">
                ...
                <div class="relative flex items-center justify-between">
                    <!-- Logo -->
                    <a href="<?php echo e(route('home')); ?>" @click="mobileMenuOpen = false" class="flex-shrink-0">
                        <img src="<?php echo e(asset('images/logo.png')); ?>" alt="NiPergo" class="h-8">
                    </a>
            ...
            <div
                ...
                <div class="flex items-center justify-between gap-2">
                    <a href="tel:<?php echo e(setting('contact_phone', '+90 532 134 30 16')); ?>"
                        ...
                        <span
                            class="text-xs text-slate-500 dark:text-slate-400"><?php echo e(setting('contact_phone', '+90 532 134 30 16')); ?></span>
                    </a>
                    <div class="flex items-center gap-1">
                        <?php if(setting('social_instagram')): ?>
                            <a href="<?php echo e(setting('social_instagram')); ?>" target="_blank"
                        ...
                        <?php if(setting('whatsapp')): ?>
                            <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', setting('whatsapp'))); ?>" target="_blank"
            ...
            <div class="flex-1 overflow-y-auto p-3 space-y-1">
                <a href="<?php echo e(route('home')); ?>" @click="mobileMenuOpen = false"
                        ...
                        <?php if($category->children->count() || $category->products->count()): ?>
                            <div x-show="mobileSubmenuOpen === <?php echo e($category->id); ?>" x-collapse class="pb-2 px-2">
                                <div class="space-y-1 pt-1 ml-10 border-l-2 border-slate-100 dark:border-slate-800 pl-3">
                                    <?php $__currentLoopData = $category->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <a href="<?php echo e(route('category', $child->slug)); ?>" @click="mobileMenuOpen = false"
                ...
                <a href="<?php echo e(route('blog')); ?>" @click="mobileMenuOpen = false"
