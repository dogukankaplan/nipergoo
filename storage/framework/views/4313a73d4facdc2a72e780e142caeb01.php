...
<header x-data="{ 
        ...
        <div class="container mx-auto px-4 lg:px-8 h-full flex items-center justify-between relative">
            ...
            <div class="flex items-center gap-4 ml-auto">
                ...
                <a href="tel:<?php echo e(setting('contact_phone', '+90 532 134 30 16')); ?>"
                    ...
                    <span
                        class="text-xs font-medium tracking-wide"><?php echo e(setting('contact_phone', '+90 532 134 30 16')); ?></span>
                </a>
        ...
        <div class="container mx-auto px-4 lg:px-8">
            <div class="flex items-center justify-between transition-all duration-500"
                ...
                <a href="<?php echo e(route('home')); ?>" class="flex-shrink-0 group relative z-10">
                    ...
                    <?php else: ?>
                        <img src="<?php echo e(asset('images/logo.png')); ?>" alt="NiPergo"
    ...
    <div x-show="mobileMenuOpen" class="fixed inset-0 z-[70] lg:hidden" x-cloak>
        ...
        <!-- Drawer Panel -->
        <div class="absolute inset-y-0 right-0 w-[85%] max-w-sm bg-white dark:bg-slate-900 shadow-2xl flex flex-col overflow-hidden"
            ...
            <div class="relative px-6 py-5 border-b border-slate-100 dark:border-slate-800">
                ...
                <div class="relative flex items-center justify-between">
                    <span
                        class="font-display font-black text-xl text-slate-900 dark:text-white flex items-center gap-0.5">
                        <?php echo e(setting('site_name', 'NiPergo')); ?>

                        <span
                            class="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent text-2xl">.</span>
                    </span>
            ...
            <div class="flex-1 overflow-y-auto p-4 space-y-1">
                <a href="<?php echo e(route('home')); ?>"
                    class="mobile-nav-item block px-4 py-3.5 rounded-xl text-base font-semibold text-slate-700 dark:text-slate-200 hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 dark:hover:from-blue-900/20 dark:hover:to-indigo-900/20 hover:text-blue-600 dark:hover:text-blue-400 transition-all">
                    Anasayfa
                </a>

                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="mobile-nav-item rounded-xl overflow-hidden"
                        style="animation-delay: <?php echo e(($index + 1) * 0.05); ?>s">
                        <button @click="toggleMobileSubmenu(<?php echo e($category->id); ?>)"
                            ...
                            <?php if($category->children->count() || $category->products->count()): ?>
                                <svg class="w-4 h-4 transition-transform duration-300"
                                    :class="mobileSubmenuOpen === <?php echo e($category->id); ?> ? 'rotate-180 text-blue-500' : 'text-slate-400'"
                                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div class="space-y-1 pt-1">
                                    <?php $__currentLoopData = $category->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <a href="<?php echo e(route('category', $child->slug)); ?>"
                                            ...
                                            <span
                                                class="w-1.5 h-1.5 rounded-full bg-gradient-to-br from-blue-400 to-indigo-500"></span>
                                    ...
                                    <?php $__currentLoopData = $category->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <a href="<?php echo e(route('product', [$category->slug, $product->slug])); ?>"
                                            class="flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium text-slate-500 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-white dark:hover:bg-slate-800 transition-all">
                                            <span
                                                class="w-1.5 h-1.5 rounded-full bg-gradient-to-br from-purple-400 to-pink-500"></span>
